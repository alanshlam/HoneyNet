...
| **Attack Countries**    | USA (top: HK: 549,721; UK: 800,062; USA: 1,266,211; AUS: 755,017), Romania, China consistent; Romania focuses on port 5060. | Diversification of attack sources (e.g., South Africa, Brazil) due to cheap hosting.   | Monitor and block USA/Romania IPs, especially for port 5060 traffic.                |
